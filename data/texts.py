...
groups_empty = """
У вас нет подключенных групп. Нажмите "Добавить" чтобы добавить группу."""
...
add_group_message = """
Введите название группы обсуждения вашего канала в первой строке и ссылку-приглашение во второй.
Например:
"Моя Группа
https://t.me/some_group_xxxxx"
"""
